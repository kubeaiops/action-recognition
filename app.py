...
def analyze(filename):
    ...
    print('API - calling analyse_video, filename', filename)
    return Response(analyze_video(pose_detector, lstm_classifier, filename), mimetype='text/event-stream')


if __name__ == '__main__':
    app.run(debug=True, use_reloader=True, port=4444)
